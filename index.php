/**
 * Proyek ini dilindungi oleh hak cipta dan lisensi ISC.
 * Pengembangan proyek ini dilakukan oleh Dani Technology (Full Stack Developer & Software Engineer) 
 * pada tanggal 4 Maret 2025. Perlu diingat bahwa pelanggaran hak cipta dapat mengakibatkan konsekuensi hukum 
 * yang serius, termasuk ganti rugi dan tindakan hukum lainnya. Oleh karena itu, kami berharap Anda untuk 
 * menghormati hak cipta kami dan tidak melakukan tindakan yang dapat melanggar hak cipta ini.
 *
 * KONTAK DEVELOPER:
 ...
 *   sesuai dengan ketentuan Pasal 113 Undang-Undang Hak Cipta No. 28 Tahun 2014.
 * - Penghentian penggunaan proyek ini dan semua derivatifnya, sesuai dengan ketentuan Pasal 114 
 *   Undang-Undang Hak Cipta No. 28 Tahun 2014.
 * - Tindakan hukum lainnya yang sesuai, termasuk tuntutan pidana dan perdata, sesuai dengan ketentuan 
 *   Pasal 115 Undang-Undang Hak Cipta No. 28 Tahun 2014.
 *
 ...
 *
 * DENGAN MENGGUNAKAN PROYEK INI, ANDA MENYATAKAN BAHWA ANDA TELAH MEMBACA, MEMAHAMI, 
 * DAN MENYETUJUI SYARAT-SYARAT LISENSI DAN HAK CIPTA INI.
 *
 * PERINGATAN AKHIR:
 * Dengan ini, kami memberikan peringatan bahwa pelanggaran hak cipta atas proyek ini akan diambil tindakan hukum yang serius.
 * Jika Anda terbukti menjual atau mengklaim proyek ini sebagai milik Anda sendiri tanpa izin, kami akan mengambil langkah-langkah hukum 
 * yang diperlukan untuk melindungi hak cipta kami, termasuk ganti rugi dan tindakan hukum lainnya.
 */
